...
extern "C"
{
	...
	UNITY_EXPORT bool Unity_SetMojingWorld(const char * szGlassesName, bool bUseTimeWarp);
	...
	UNITY_EXPORT void Unity_ReprotLog(int iLogType, const char* szTypeName, const char* szLogContent);
}
